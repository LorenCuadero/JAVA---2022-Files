 ...
 */
public class CashierRegist extends javax.swing.JFrame {

    /**
     * Creates new form Register_Form
     */
    public CashierRegist() {
        initComponents();
...
//        frame.setVisible(true);
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cashier", " ", " " }));
        ...
        if (fname.equals("")) {
            ...
            try {
                ...
                if (ps.executeUpdate() > 0) {
                    JOptionPane.showMessageDialog(null, "You are Added as Cashier");
                }
...
//        }
    ...
    public boolean checkUsername(String username) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CashierRegist.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CashierRegist().setVisible(true);
            }
        });
    }
