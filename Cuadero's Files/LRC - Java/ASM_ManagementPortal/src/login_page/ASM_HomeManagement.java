        ...
        try {
            ...
            while (rs.next()) {
                ...
                for (int a = 1; a <= c; a++) {
                    ...
                    v2.add(rs.getString("Type of User"));
                }
                model.addRow(v2);
            }
...
//            jfname.requestFocus();
    ...
    private void jupdateActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        PreparedStatement ps;
        String query = "UPDATE  `users` SET (`First_name` =?,`Last_name` =?,`Username` =?,`Password` =? ,`Address` =?,`Type of User`=? WHERE `User_Id`=?";
...
//    
    ...
    private void jidKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jidKeyPressed
       JOptionPane.showMessageDialog(null,"Attention: Employee Id will automatically ");
